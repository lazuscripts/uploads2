...
class extends Widget
  content: =>
    link href: "/static/fine-uploader/fine-uploader-gallery.min.css", rel: "stylesheet"
    script src: "/static/fine-uploader/fine-uploader.min.js",
        ...
        ul class: "qq-upload-list-selector qq-upload-list", role: "region", "aria-live": "polite", "aria-relevant": "additions removals", ->
          li ->
            ...
            div class: "qq-thumbnail-wrapper", ->
              img class: "qq-thumbnail-selector", "qq-max-size": 120, "qq-server-scale": true
            button type: "button", class: "qq-upload-cancel-selector qq-upload-cancel", "X"
            button type: "button", class: "qq-upload-retry-selector qq-upload-retry", ->
              span class: "qq-btn qq-retry-icon", "aria-label": "Retry"
              text "Retry"
    ...
    script -> raw "
      var uploader = new qq.FineUploader({
        ...
        chunking: {
          ...
          // partSize: 6*1024*1024, // 6 MB should do it? // default is 2 MiB
          success: {
            endpoint: '/upload/finished'
          }
        },
        resume: {
          enabled: true,
        ...
        deleteFile: {
          enabled: true,
          endpoint: '/upload' // maybe should be different ??
        }
      });
    "
